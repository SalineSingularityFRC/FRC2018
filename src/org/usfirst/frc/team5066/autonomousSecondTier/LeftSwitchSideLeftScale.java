...
public class LeftSwitchSideLeftScale extends AutonControlScheme{

	public LeftSwitchSideLeftScale(SingDrive drive, AHRS gyro, Arm arm, Intake intake) {
	...
	public void moveAuton() {
		...
		super.verticalReverse(103.65, Arm.Position.HIGHSCALE, false);
		intake.autonOuttake();
	}
